...
Currently I work as a data scientist at Freelancer.com Limited, where I have been responsible for a lot of the spam and fraud countermeasures of the company, as well as working on a real-time data streaming pipeline, specifically on graph databases and ML model deployment.